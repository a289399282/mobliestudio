...
export const getlunbo = data => fetch('mainimg/list', data, 'get');

/**
 * 获取通知公告
 */

export const getnotice = data => fetch('noti/list', data, 'get');

/**
 * 获取新闻动态
 */

export const getnews = data => fetch('news/list', data, 'get');

/**
 * 获取简介
 */

export const gethomeinfo = data => fetch('brinfo/list' , data , 'get');

/**
 * 获取介绍
 */

export const getintro = data => fetch('intro/list', data, 'get');

/**
 * 获取项目与服务条目表
 */

export const getproditem = data => fetch('/item/tree', data, 'get');

/**
 * 获取项目与服务
 */

export const getprod = data => fetch('prod/list', data, 'get');

/**
 * 获取岗位
 */

export const getjob = data => fetch('job/list', data, 'get');

/**
 * 添加成员
 */

export const addmember = data => fetch('item/add', data, 'POST');
